    ...
    return (
        <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Ємність X (л)</label>
                    <input
                        type="number"
                        min="1"
                        value={jugX}
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Ємність Y (л)</label>
                    <input
                        type="number"
                        min="1"
                        value={jugY}
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Цільовий обʼєм (л)</label>
                    <input
                        type="number"
                        min="1"
                        value={target}
